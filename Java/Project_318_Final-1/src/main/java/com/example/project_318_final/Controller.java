        ...
        for (Texnikos t : texnikos_repository.findAll()) {//gia kathe texniko
            ...
            for (String s : topothesiaArray) {//gia kathe mia apo tis topothesies tou texnikou
                if ((p.getTopothesiaPelati().equals(s))) {
                    ...
                    //Texnikos_match
                    m.setNameTexnikou(t.getNameTexnikou());
                    m.setEmailTexnikou(t.getEmailTexnikou());
                    m.setTopothesiaTexnikou(t.getTopothesiaTexnikou());
                    m.setEpilogiTexnikou_apotexniko(t.getEpilogiTexnikou_apotexniko());
                    ...
                    if (m.getEpilogiTexnikouMatch() == 1) {//idravlikos
                        ...
                        //Texnikos_match
                        i.setNameTexnikou(t.getNameTexnikou());
                        i.setEmailTexnikou(t.getEmailTexnikou());
                        i.setTopothesiaTexnikou(t.getTopothesiaTexnikou());
                        i.setEpilogiTexnikou_apotexniko(t.getEpilogiTexnikou_apotexniko());
                        idravlikos_repository.save(i);
                        System.out.println("KATAXWRISI 1 -> ");

                        EMAIL_OTI_IPARXI_NEA_KRATISI(i.getEmailTexnikou());//steile email ston texniko
                        ...
                        //Texnikos_match
                        ps.setNameTexnikou(t.getNameTexnikou());
                        ps.setEmailTexnikou(t.getEmailTexnikou());
                        ps.setTopothesiaTexnikou(t.getTopothesiaTexnikou());
                        ps.setEpilogiTexnikou_apotexniko(t.getEpilogiTexnikou_apotexniko());
                        System.out.println("KATAXWRISI 2 -> ");

                        psiktikos_repository.save(ps);
                        EMAIL_OTI_IPARXI_NEA_KRATISI(ps.getEmailTexnikou());//steile email ston texniko
                        System.out.println("****"   );
                        ...
                        //Texnikos_match
                        h.setNameTexnikou(t.getNameTexnikou());
                        h.setEmailTexnikou(t.getEmailTexnikou());
                        h.setTopothesiaTexnikou(t.getTopothesiaTexnikou());
                        h.setEpilogiTexnikou_apotexniko(t.getEpilogiTexnikou_apotexniko());
                        hlektrologos_repository.save(h);

                        System.out.println("KATAXWRISI 3-> ");

                       EMAIL_OTI_IPARXI_NEA_KRATISI(h.getEmailTexnikou());//steile email ston texniko
                        System.out.println("****"   );
